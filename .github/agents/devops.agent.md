---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-users, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-users`.
...
- Checkout local: `app-community/modules/controleonline/ui-users`
